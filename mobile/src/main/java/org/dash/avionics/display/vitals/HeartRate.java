...
class HeartRate extends Widget {
  ...
  public HeartRate(DisplayConfiguration config, AssetManager assets, float x, float y, float w, float h) {
    super(x, y, w, h);
  ...
  protected void drawContents(Canvas canvas) {
    canvas.drawText("123bpm", getX() + 0.95f * getWidth(), textSize, textPaint);
  }
}
